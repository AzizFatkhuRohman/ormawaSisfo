        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Ormawa sisfo</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="<?=base_url('/galeri')?>" class="menu-link">
              <i class='menu-icon tf-icons bx bx-book-content'></i>
                <div data-i18n="Analytics">Galeri</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?=base_url('/dokumen')?>" class="menu-link">
              <i class='menu-icon tf-icons bx bxs-user-rectangle'></i>
                <div data-i18n="Analytics">Dokumen</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?=base_url('/laporanPengaduan')?>" class="menu-link">
              <i class='menu-icon tf-icons bx bx-home-circle'></i>
