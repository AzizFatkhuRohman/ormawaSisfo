            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">OrmawaSisfo</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Selamat Datang Di OrmawaSisfo! 👋</h4>
              <p class="mb-4">Silahkan <?=lang('Auth.loginTitle')?></p>
              ...
              <?php if ($config->validFields === ['email']): ?>
                ...
                <div class="mb-3">
                  <div class="form-check">
                    <input class="form-check-input" <?php if (old('remember')) : ?> checked <?php endif ?> type="checkbox" id="remember-me" />
